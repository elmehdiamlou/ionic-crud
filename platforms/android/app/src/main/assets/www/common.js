...
/* harmony export */   "UserCrudService": () => (/* binding */ UserCrudService)
/* harmony export */ });
...
let UserCrudService = class UserCrudService {
    ...
    createUser(user) {
        return this.httpClient.post('http://localhost:5000/api/create-user', user, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError('Error occured')));
    }
    getUser(id) {
        return this.httpClient.get('http://localhost:5000/api/fetch-user/' + id)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(_ => console.log(`User fetched: ${id}`)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError(`Get user id=${id}`)));
    }
    getUsers() {
        return this.httpClient.get('http://localhost:5000/api')
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(users => console.log('Users retrieved!')), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError('Get user', [])));
    }
    updateUser(id, user) {
        return this.httpClient.put('http://localhost:5000/api/update-user/' + id, user, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(_ => console.log(`User updated: ${id}`)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError('Update user')));
    }
    deleteUser(id) {
        return this.httpClient.delete('http://localhost:5000/api/delete-user/' + id, this.httpOptions)
            .pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.tap)(_ => console.log(`User deleted: ${id}`)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_1__.catchError)(this.handleError('Delete user')));
    }
...
UserCrudService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var _home_aml_Desktop_Angular_ionic_tp1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_home_aml_Desktop_Angular_ionic_tp1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_home_aml_Desktop_Angular_ionic_tp1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_home_aml_Desktop_Angular_ionic_tp1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_home_aml_Desktop_Angular_ionic_tp1_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
